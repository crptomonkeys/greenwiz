...
WALLETLINK_LOG_CHANNEL = 773125535240290305
...
try:
    ...
    BANANO_DISTRIBUTION_AUTH_CODE = settings_priv.BANANO_DISTRIBUTION_AUTH_CODE
    DISCORD_USER_LIST_AUTH_CODE = settings_priv.DISCORD_USER_LIST_AUTH_CODE
    ...
    AW_BLACKLIST = settings_priv.AW_BLACKLIST
    AW_BLACKLIST_AUTH_KEY = settings_priv.AW_BLACKLIST_AUTH_KEY
    ADVENT_OF_CODE_COOKIE = settings_priv.ADVENT_OF_CODE_COOKIE
    BAD_SANTA_ACC_NAME = settings_priv.BAD_SANTA_ACC_NAME
    BAD_SANTA_PRIV_KEY = settings_priv.BAD_SANTA_PRIV_KEY
    ...
    BANANO_DISTRIBUTION_AUTH_CODE = os.getenv("BANANO_DISTRIBUTION_AUTH_CODE")
    DISCORD_USER_LIST_AUTH_CODE = os.getenv("DISCORD_USER_LIST_AUTH_CODE")
    ...
    AW_BLACKLIST = os.getenv("AW_BLACKLIST")
    AW_BLACKLIST_AUTH_KEY = os.getenv("AW_BLACKLIST_AUTH_KEY")
    ADVENT_OF_CODE_COOKIE = os.getenv("ADVENT_OF_CODE_COOKIE")
    BAD_SANTA_ACC_NAME = os.getenv("BAD_SANTA_ACC_NAME")
    BAD_SANTA_PRIV_KEY = os.getenv("BAD_SANTA_PRIV_KEY")
